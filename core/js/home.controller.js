    ...
    $scope.data = {
        ...
        jobCompletionData : {
            ...
            params : {
                ...
                'group by' : 'acceptedBy',
                conditions : {'acceptedBy' : ['>', 0], 'DATE(`endTime`)' : 'CURDATE()', 'status' : 1},
            },
            series : [],
            labels : [],
        ...
        jobInsertionData : {
            ...
            params : {
                ...
                'group by' : 'insertedBy',
                conditions : {'DATE(`insertTime`)' : 'CURDATE()', 'status' : ['>', -2]}
            },
            series : [],
            labels : [],
        ...
        productUsageData : {
            ...
            params : {
                ...
                'group by' : 'user_id',
                conditions : {'direction' : 0, 'DATE(`datetime`)' : 'CURDATE()'}
            },
            series : [],
            labels : [],
        ...
        moneyProdData : {
            ...
            params : {
                ...
                'group by' : 'acceptedBy',
                conditions : {'acceptedBy' : ['>', 0], 'DATE(`endTime`)' : 'CURDATE()', 'status' : ['>', -2]},
            },
            series : [],
            labels : [],
